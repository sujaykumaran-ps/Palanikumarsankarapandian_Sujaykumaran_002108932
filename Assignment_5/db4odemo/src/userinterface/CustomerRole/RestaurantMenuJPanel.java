...
public class RestaurantMenuJPanel extends javax.swing.JPanel {
     ...
     */
    public RestaurantMenuJPanel(JPanel userProcessContainer, UserAccount account, EcoSystem system, Restaurant res) {
        initComponents();
        ...
        populateMenuTable();
        titleResName.setText(res.getResName());
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if(selectedRow < 0){
            ...
            Menu item=(Menu)tblCart.getValueAt(selectedRow, 0);
            items.remove(item);
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
        ...
        CustomerAreaJPanel comp = (CustomerAreaJPanel) component;
        comp.populateOrdersTable();
        CardLayout layout = (CardLayout)userProcessContainer.getLayout();
        layout.previous(userProcessContainer);
